          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Av. Nuno de Assis, 18-50 - Bauru, SP</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="w-5 h-5 text-blue-400 mr-3 mt-1 flex-shrink-0" 
                ...
                <span className="text-gray-300">(14) 99625-1173</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="w-5 h-5 text-blue-400 mr-3 mt-1 flex-shrink-0" 
                ...
                <span className="text-gray-300">ciadofalantebauru@outlook.com</span>
              </li>
            </ul>
          </div>
        </div>
